        ...
        layout_columns(
          ...
          card(
            ...
            layout_columns(
              ...
              numericInput("numPlayers", t("num_players"), value = 3, min = 2, max = 6, step = 1)
            ),
      ...
      div(class = "tab-scroll",
          layout_columns(
            ...
            card(
              ...
              sliderInput("mu_min_games", t("mu_min_together"), min = 1, max = 20, value = 2, step = 1),
              selectInput(
                "mu_focus", t("mu_focus"),
      ...
      div(class = "tab-scroll",
          layout_columns(
            ...
            card(
              ...
              numericInput("pred_numPlayers", t("num_players"), value = 4, min = 2, max = 6, step = 1),
          ...
          layout_columns(
            ...
            card(
              ...
              layout_columns(
                ...
                numericInput("editNumPlayers", t("num_players"), value = 3, min = 2, max = 6, step = 1)
              ),
